...
protocol ProfileViewModeling {
    func requestProfileApi(apiName: String, param:[String: Any], completion: @escaping (_ response: JSON)->Void)
}

class ProfileViewModel:ProfileViewModeling{
    func requestProfileApi(apiName: String, param: [String : Any], completion: @escaping (JSON) -> Void) {

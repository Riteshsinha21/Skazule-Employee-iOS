...
//
//    }
////    func sendMessage(request: Message2, onSuccess:@escaping(String) -> Void){
////
...
////    func uploadImageURLToFirebase(request: Message2, imageURL: Data, onSuccess:@escaping(String) -> Void){
////
